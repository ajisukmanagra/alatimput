        ...
        <div class="section-body">
            <div class="mb-3">
                <ol class="breadcrumb bg-primary">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.eskul')}}" class="text-white text-decoration-none">Kelola Eskul</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <center>
                        <img src="/image/eskul/{{$eskul->gambar}}" alt="" class="img img-thumbnail border-0 rounded-lg" width="300">
                    </center>
                    <p>{!! $eskul->deskripsi !!}</p>
                </div>
            </div>
