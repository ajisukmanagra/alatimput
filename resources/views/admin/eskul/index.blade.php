        ...
        <div class="section-body">
            <div class="mb-3">
                <ol class="breadcrumb bg-primary">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Kelola Eskul</a></li>
                </ol>
            </div>
            <div class="card">
                        ...
                        <table class="table table-bordered" id="guru">
                            ...
                            @foreach ($eskuls as $no => $eskul)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/image/eskul/{{$eskul->gambar}}" style="font-size: 12px;" class="btn btn-success btn-sm">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button onClick="Delete(this.id)" class="btn btn-sm btn-danger" id="{{ $eskul->id }}">
