            ...
            <div class="section-body">
                <div class="mb-3">
                    <ol class="breadcrumb bg-primary">
                        ...
                        <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Tambah Caraka</a></li>
                    </ol>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Tambah Caraka</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.caraka.post') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_caraka" value="{{ old('nama_caraka') }}" placeholder="Masukkan Nama Pegawai" class="form-control @error('nama_caraka') is-invalid @enderror">
