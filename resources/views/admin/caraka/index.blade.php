        ...
        <div class="section-body">
            <div class="mb-3">
                <ol class="breadcrumb bg-primary">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Kelola Caraka</a></li>
                </ol>
            </div>
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-chalkboard-teacher"></i> Caraka</h4>
                </div>
                <div class="card-body">
                    <div class="container">
                        <div class="row">
                            <a href="{{route('admin.caraka.create')}}" class="btn btn-primary mb-4"><i class="fas fa-plus-circle"></i> Tambah Caraka</a>&nbsp;
                        </div>
                    </div>
                            ...
                            @foreach ($caraka as $no => $tu)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.caraka.edit', $tu->id) }}" class="btn btn-sm btn-primary">
