            ...
            <div class="section-body">
                <div class="mb-3">
                    <ol class="breadcrumb bg-primary">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.kegiatan.ekstrakulikuler.index')}}" class="text-white text-decoration-none">Kegiatan Ekstrakulikuler</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.kegiatan.ekstrakulikuler.post') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date'), date('d-m-Y') }}">
                                @error('date')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
