        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container">
                        <div class="row">
                            <a href="{{route('admin/kegiatan/ekstrakulikuler/add')}}" class="btn btn-primary mb-4"><i class="fas fa-plus-circle"></i> Tambah Ekstrakulikuler</a>&nbsp;
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered" id="guru">
                            ...
                            @foreach ($kegiatans as $no => $kegiatan)
                                <tr>
                                    ...
                                    <td><img src="{{asset('image/kegiatan/'. $kegiatan->image)}}" alt="" width="150"></td>
                                    <td>{{ date('d-m-Y', strtotime($kegiatan->date))}}</td>
                                    <td class="text-center">
                                        <a href="{{route('admin.ekstrakulikuler.edit', $kegiatan->id)}}" class="btn btn-sm btn-primary">
