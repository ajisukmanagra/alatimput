            ...
            <div class="section-body">
                <div class="mb-3">
                    <ol class="breadcrumb bg-primary">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.kegiatan.intrakulikuler.index')}}" class="text-white text-decoration-none">Kegiatan Intrakulikuler</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.kegiatan.intrakulikuler.post') }}" method="POST" enctype="multipart/form-data">
                            @csrf
