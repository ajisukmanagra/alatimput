            ...
            <div class="section-body">
                <div class="mb-3">
                    <ol class="breadcrumb bg-primary">
                        ...
                        <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Tambah Tata Usaha</a></li>
                    </ol>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Tambah Tata Usaha</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.tatausaha.post') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_pegawai" value="{{ old('nama_pegawai') }}" placeholder="Masukkan Nama Pegawai" class="form-control @error('nama_pegawai') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                <label>NIP</label>
                                <input type="text" name="nip" value="{{ old('nip') }}" placeholder="Masukkan NIP" class="form-control @error('nip') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jabatan" class="form-control @error('jabatan') is-invalid @enderror">
                                    ...
                                    <option value="Sekretaris">Kepala Sekretaris</option>
