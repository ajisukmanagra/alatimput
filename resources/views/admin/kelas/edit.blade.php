                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.kelas.post') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_kelas" value="{{ $kelas->nama_kelas }}" placeholder="Masukkan Nama Kelas" class="form-control @error('nama_kelas') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <select name="walikelas_id" id="" class="form-control @error('walikelas_id') is-invalid @enderror">
                                    ...
                                    @foreach($walikelas as $w)
                                        <option value="{{$w->id}}" @if($kelas->walikelas_id == $w->id) selected @endif>{{$w->nama_walikelas}}</option>
                                    @endforeach
                                </select>
