            ...
            <div class="section-body">
                <div class="mb-3">
                    <ol class="breadcrumb bg-primary">
                        <li class="breadcrumb-item"><a href="{{route('admin')}}" class="text-white text-decoration-none">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('akun.siswa.index')}}" class="text-white text-decoration-none">Kelola Akun Siswa</a></li>
                        <li class="breadcrumb-item"><a href="" class="text-white text-decoration-none">Edit Akun Siswa</a></li>
                    </ol>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Edit Akun Siswa</h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('akun.siswa.post') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="level" class="form-control @error('level') is-invalid @enderror">
                                    ...
                                    <option value="Siswa" @if($akun->level == 'Siswa') selected @endif>Siswa</option>
                                </select>
