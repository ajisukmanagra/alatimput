...
<header class="pt-3 border-bottom">
    <div class="container pt-md-1 pb-md-1">
        <h3 class="bd-title mt-3 mb-4 font-weight-bold" style="color: #0099ff;"><i class="fas fa-running" aria-hidden="true"></i> EKSTRAKULIKULER</h3>
    </div>
</header>
...
<div class="row mt-5">
    ...
    <div class="col-lg-4 mb-3">
        <div class="card shadow">
            <img src="/image/eskul/{{$e->gambar}}" alt="" class="card-img-top" style="height:250px;">
            <div class="card-body">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <center>
                        <img src="/image/eskul/{{$e->gambar}}" alt="" class="img img-thumbnail mt-4" width="200">
                    </center>
