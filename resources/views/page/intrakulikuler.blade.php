    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-4 mb-3">
            <div class="card shadow">
                <a href="/image/kegiatan/{{$k->image}}" target="__blank">
                    <img src="/image/kegiatan/{{$k->image}}" alt="" class="card-img-top" style="height:250px;">
                </a>
                <div class="card-body">
                    <h6>{{$k->title}}</h6>
                    <p class="mb-0">Tanggal : {{date('d-m-Y', strtotime($k->date))}}</p>
                </div>
            </div>
        </div>
        @endforeach
