...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/materi/materi">
         <i class="fa fa-book fa-2x text-primary" aria-hidden="true"></i>
          <span>Materi</span>
        </a>
       <li class="nav-item">
        <a class="nav-link collapsed" href="/tugas/tugas">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="/ujian/ujian">
         <i class="fas fa-stream fa-2x text-primary" aria-hidden="true"></i>
          <span>Profil</span>
        </a>
      </li><i class=""></i>
         <li class="nav-item">
        <a class="nav-link collapsed" href="/nilai/nilai">
