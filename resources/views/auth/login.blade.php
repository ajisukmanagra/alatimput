...
<body>
    <div class="main">
        <div class="container">
            <h2 class="text-center text-white">SMP PGRI CIRANJANG</h2>
            ...
            <div class="middle mt-5">                                                                                                                                                                                                                                                                                                  
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <fieldset class="clearfix">
                                ...
                                <p>
                                    ...
                                    <input id="username" type="text" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus placeholder="username">
                                </p>
                    ...
                    <div class="logo">
                        <img src="{{ asset('seer/PGRI.png') }}" alt="" width="70%">
                        <div class="clearfix"></div>
                    </div>
