...
<body>
    <form action="/tujuh/tujuh-a/store" method="POST">
    ...
    @csrf
        ...
        <p>
            ...
            <input type="text" name="mata_pelajaran" placeholder="Nama Tugas">
        </p>
        <p>
        ...
        <p>
            ...
            <input type="text" name="nama" placeholder="Nama Pendidik">
        </p>
